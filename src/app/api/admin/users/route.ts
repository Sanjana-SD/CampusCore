...
import { mockFaculty, mockStudents } from '@/lib/mockData';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    let filtered = profiles && profiles.length > 0 ? profiles : (roleFilter === 'faculty' ? mockFaculty : mockStudents);
    ...
    const fallback = roleFilter === 'faculty' ? mockFaculty : mockStudents;
