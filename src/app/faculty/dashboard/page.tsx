      ...
      if (!activeProfile) {
        ...
        if (rawSession) {
          try {
            ...
            activeProfile = { full_name: sess.full_name || 'Prof. Demo Faculty', email: sess.email || 'faculty@campuscore.edu', role: 'faculty' };
          } catch (e) {}
        }
      }

      if (!activeProfile) {
        activeProfile = { full_name: 'Prof. Demo Faculty', email: 'faculty@campuscore.edu', role: 'faculty' };
      }
